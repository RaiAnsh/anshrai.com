export const projects = [
  ...
  
  {
    ...
    desc: "Client site delivered in Wix. This is a React recreation preview to showcase layout, styling, and UI structure.",
  ...
  },
  {
    ...
    desc:
      "A modern, responsive business website rebuilt from scratch with a focus on layout, usability, and clean design.",
  ...
  {
    slug: "utility-app",
    title: "Utility / Dashboard App",
    desc:
      "A small web application focused on logic, state management, and practical UI patterns.",
    tags: ["State", "Forms", "UX"],
    status: "Planned",
    featured: false,
    href: null,
